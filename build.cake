...
var nuspec = File("./Cake.Mage.nuspec");
var solutionPath = File("./Cake.Mage.sln");
var artifacts = "./build/";
...
Task("test")
    ...
    .Does(() => 
{
    XUnit2("tests/Cake.Mage.Tests/bin/release/Cake.Mage.Tests.dll",
        new XUnit2Settings {
    ...
    if(AppVeyor.IsRunningOnAppVeyor)
    {
        ...
        AppVeyor.UploadTestResults("./build/Cake.Mage.Tests.dll.xml", AppVeyorTestResultsType.XUnit);
    }
});
