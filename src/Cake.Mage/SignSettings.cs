...
namespace Cake.Mage
{
    ...
    public class SignSettings : ToolSettings
    {
        ...
        /// <summary>
        /// Specifies The location of a digital certificate for signing a manifest
        /// </summary>
        ...
        /// <summary>
        /// <para>
        /// The hash of a digital certificate stored in the personal certificate store
        ...
        /// <summary>
        /// The password that is used for signing a manifest with a digital certificate. Must be 
